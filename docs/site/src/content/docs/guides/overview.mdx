...
and any training backend ([slime](/agentcore-rl-toolkit/guides/slime-backend-setup/), [rllm](/agentcore-rl-toolkit/guides/rllm-backend-setup/), or [verl](/agentcore-rl-toolkit/guides/verl-backend-setup/)) can drive
it.
