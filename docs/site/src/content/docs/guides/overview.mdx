...
you deploy**. Keep your [Bedrock AgentCore](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/agents-tools-runtime.html) agent, swap [one decorator](/agentcore-rl-toolkit/guides/agent-adaptation/),
and any training backend ([slime](/agentcore-rl-toolkit/guides/slime-backend-setup/), [rllm](/agentcore-rl-toolkit/guides/rllm-backend-setup/), [verl](/agentcore-rl-toolkit/guides/verl-backend-setup/), or [SageMaker](/agentcore-rl-toolkit/guides/sagemaker-backend-setup/)) can drive
it.
...
- **Framework agnostic** — any agent framework ([LangGraph](https://langchain-ai.github.io/langgraph/), [Strands](https://strandsagents.com/),
  or custom) and any foundation model. The agent's runtime
...
- **Shared data plane** (center) —
  [`model-gateway`](https://github.com/rllm-org/rllm/tree/main/rllm-model-gateway)
